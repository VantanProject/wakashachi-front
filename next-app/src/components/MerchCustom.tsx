...
export function MerchCustom({ type, onSubmit, setMerch, merch }: MerchCustomProps) {
            ...
            <div className="flex md:flex-row gap-16">
                <div className="flex justify-end">
                    <div className="flex flex-col items-center">
                        <div className="w-full pl-3 text-lg font-bold text-[#999999]">アレルギー</div>
                        <div className="mb-10 w-full border-2 flex items-center p-2 bg-white rounded-md">
                            <Select
                                ...
                                options={allergies}
                                multi={true}
                                onChange={(selectedItems: SelectItem[]) => setMerch(prevMerch => ({
                                    ...prevMerch,
